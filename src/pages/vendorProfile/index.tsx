...
import * as styles from './vendorProfile.styes';
    ...
    <Container>
      ...
      <Box sx={styles.gridBox}>
        <Box sx={{ gridColumn: 'span 3' }}>
          <Box sx={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', p: 3, borderRight: '1px solid', borderColor: 'gray.100', }} gap={3}>
