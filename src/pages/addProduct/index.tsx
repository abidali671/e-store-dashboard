            ...
            <Box sx={{ border: '1px solid', borderColor: 'gray.100', borderRadius: '20px' }}>
                <Box sx={{ display: 'grid', p: 3, gap: 3, gridTemplateColumns: 'repeat(12,1fr)' }}>
                    <Box gridColumn={{ md: 'span 4', xs: 'span 12' }}>
                        ...
                        >
                            <Box>
                                <Typography variant='h3' fontWeight='bold' textAlign='center' color='gray.500'>
                                    765 x 850
                                </Typography>
                        ...
                        <Stack justifyContent='space-between' flexDirection='row' alignItems='center'>
                            ...
                            <Box>
                                ...
                                <Stack flexDirection='row'>
                                    <Typography variant='body1' color='gray.300'><Checkbox style={{ padding: '0px' }} defaultChecked={false} size='small' />S</Typography>
                                    <Typography variant='body1' color='gray.300'><Checkbox style={{ padding: '0px' }} defaultChecked={false} size='small' />L</Typography>
                                    <Typography variant='body1' color='gray.300'><Checkbox style={{ padding: '0px' }} defaultChecked={false} size='small' />XL</Typography>
                                    <Typography variant='body1' color='gray.300'><Checkbox style={{ padding: '0px' }} defaultChecked={false} size='small' />XXL</Typography>
