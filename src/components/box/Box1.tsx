				...
				return (
					<>
						{item.full ? (
							...
							<Grid item xs={6} sm={3} md={item.md}>
								<Item sx={{ padding: 0, height: '99%' }}>
									<Box sx={{ width: '100%',height: '100%' }}>
										...
										{item.bottom && <Box p={3} sx={{ borderTop: '1px solid #7D767680' }}>
											<Typography sx={{color:'#86AAF1'}} fontWeight='bold' variant='caption' color='inherit'>
												{item.bottom}
											</Typography>
										</Box>}
									</Box>
